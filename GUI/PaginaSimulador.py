...
class PaginaSimulador(tk.Frame):
    ...
    def draw(self):
        ...
        if not self.simulador_optimo == None:
            ...
            self.tstatsopt.insert('', 'end', values=("Fragmentacion Interna",self.simulador_optimo.stats.FragmentacionInterna/1024))
            self.tstatsopt.insert('', 'end', values=("RAM Utilizada",self.simulador_optimo.stats.RAMUtilizada/1024))
            self.tstatsopt.insert('', 'end', values=("VRAM Utilizados",self.simulador_optimo.stats.VRAMUtilizada/1024))
        ...
        if not self.simulador == None:
            ...
            self.tstats.insert('', 'end', values=("Fragmentacion Interna",(self.simulador.stats.FragmentacionInterna /1024)))
            self.tstats.insert('', 'end', values=("RAM Utilizada",self.simulador.stats.RAMUtilizada/1024))
            self.tstats.insert('', 'end', values=("VRAM Utilizados",self.simulador.stats.VRAMUtilizada/1024))
